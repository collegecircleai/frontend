...
export default function Login() {
  ...
  useEffect(() => {
    ...
    router.replace(user.isOnboarded === false ? "/onboarding" : "/dashboard");
  ...
  return (
    <>
      ...
      {isMobile && showIntro && (
        ...
        >
          ...
          <div style={{
            ...
            height: "240px",
            borderRadius: "50%",
            background: "radial-gradient(circle, rgba(77,63,255,0.15) 0%, rgba(0,200,150,0.08) 50%, transparent 70%)",
            animation: "gradientPulse 2s ease-in-out infinite",
            filter: "blur(30px)",
            pointerEvents: "none",
          }} />
          <div style={{ fontSize: "64px", animation: "wave 0.4s ease-in-out infinite alternate", transformOrigin: "70% 80%", display: "inline-block", position: "relative", zIndex: 2 }}>
            👋
          </div>
          <div
            style={{
      ...
      <div className="hidden lg:block w-[33%] min-h-screen">
       ...
       {/* Right panel */}
      <div className="flex-1 flex flex-col justify-center items-center relative w-full" style={{ padding: isMobile ? "24px" : "64px" }}>
              ...
              <div style={{ marginBottom: "8px" }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => (e.currentTarget.style.color = "#4D3FFF")}

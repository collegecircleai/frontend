...
export default function PricingPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Use a Promise.race to prevent long hangs
        ...
        const [pkgRes, creditRes] = results;
        ...
        // Keep fallback packages so user isn't blocked
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) {
   ...
   return (
    <div style={{ padding: isMobile ? "24px 20px" : "40px 56px", maxWidth: 1200, margin: "0 auto" }}>

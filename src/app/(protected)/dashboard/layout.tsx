  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
      ...
      >
        ...
        <circle cx="52" cy="32" r="20" fill="var(--pearl, #FFFFFF)" />
        <circle cx="52" cy="32" r="14" fill="var(--pearl, #FFFFFF)" />
        <circle
          cx="52"
          cy="32"
          r="9"
          ...
          opacity="0.9"
        />
        <circle cx="32" cy="40" r="10" fill="var(--pearl, #FFFFFF)" />
        <circle cx="52" cy="32" r="4" fill="var(--pearl, #FFFFFF)" />
      </svg>
      {!collapsed && (
        <div>
          <div
...
export default function DashboardLayout({
  ...
  const getPageTitle = () => {
    if (pathname.includes("/analytics")) return "CC>AI Analytics";
    return "CC>AI Dashboard";
  };
  ...
  return (
    ...
    >
      ...
      >
        {/* Top strip: position fixed to be absolutely constant */}
        <div
          style={{
            position: "fixed",
            top: 0,
        ...
        {/* Page content */}
        <div style={{ padding: isMobile ? "12px 20px" : "32px", paddingBottom: isMobile ? "88px" : "32px" }}>
          {children}
        </div>
      </div>
    </div>

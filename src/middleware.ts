...
export function middleware(request: NextRequest) {
  ...
  if (!isLaunched) {
    // Allow the Launch page (root), Preview Landing Page, Student Community Page, and About Page
    if (pathname !== '/' && pathname !== '/preview' && pathname !== '/student-community' && pathname !== '/about') {

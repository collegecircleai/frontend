  ...
  return (
    <>
          ...
          <div style={{
            ...
            >
              ...
              <motion.h1 style={{
                ...
                <StaggeredText text="Learn Anything." delay={0} /><br />
                <motion.span 
                  variants={{
      ...
      <main 
        ...
        style={{
          flex: 1, minHeight: '100dvh', flexDirection: 'column', 
        ...
        <div style={{
          ...
          <motion.div variants={staggerContainer} initial="hidden" animate="show" style={{ textAlign: 'center' as const }}>
            ...
            <motion.h1 style={{
              ...
              <StaggeredText text="Learning," delay={0} /><br />
              <StaggeredText text="Redefined." delay={0.2} italic />
            </motion.h1>
          ...
          <div style={{ 
            ...
            >
              <motion.div
                initial={{ opacity: 0, scale: 0.95, rotateX: 10, rotateY: -5, y: 20 }}
